...
import toenailImg from "../assets/ingrown toenail surgeries.png"; // Make sure the image exists
import { Link } from "react-router-dom";

const IngrownToenailSurgery = () => {
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-10 text-center">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-4">
            {t("Ingrown toenail surgeries")}
          </h1>
          <p className="text-gray-600">
            {t(
              "Discover the causes and symptoms of ingrown toenails, and how minor surgical procedures can offer fast and lasting relief."
            )}
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <img
            src={toenailImg}
            alt={t("Ingrown toenail surgeries")}
            className="rounded-xl shadow-md w-full h-auto"
          />
          <div className="text-gray-700 space-y-4">
            <h2 className="text-2xl font-semibold text-blue-800">
              {t("What is an Ingrown Toenail?")}
            </h2>
            <p>{t("ToenailIntroP1")}</p>
            <p>{t("ToenailIntroP2")}</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12 space-y-4">
          ...
          <p className="text-gray-700">{t("ToenailBenefits")}</p>
        </div>
...
export default IngrownToenailSurgery;
