...
import laparoscopicImg from "../assets/laparoscopic surgeries.png"; // Ensure the image exists
import { Link } from "react-router-dom";

const LaparoscopicSurgeries = () => {
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-10 text-center">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-4">
            {t("Laparoscopic surgeries")}
          </h1>
          <p className="text-gray-600">
            {t(
              "Explore how laparoscopic (keyhole) surgeries offer faster recovery, less pain, and minimal scarring for a variety of conditions."
            )}
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <img
            src={laparoscopicImg}
            alt={t("Laparoscopic surgeries")}
            className="rounded-xl shadow-md w-full h-auto"
          />
          <div className="text-gray-700 space-y-4">
            <h2 className="text-2xl font-semibold text-blue-800">
              {t("What are Laparoscopic Surgeries?")}
            </h2>
            <p>{t("LaparoscopicIntroP1")}</p>
            <p>{t("LaparoscopicIntroP2")}</p>
          </div>
        </div>
        ...
        <section className="bg-white shadow-xl rounded-2xl p-8 mb-12">
          <h3 className="text-2xl font-bold text-gray-800 mb-6">
            {t("Common Laparoscopic Procedures")}
          </h3>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12 space-y-4">
          ...
          <p className="text-gray-700">{t("LaparoscopicBenefits")}</p>
        </div>
...
export default LaparoscopicSurgeries;
