...
import hemorrhoidImg from "../assets/Hemorrhoid surgery.png";
import { Link } from "react-router-dom";

const HemorrhoidSurgery = () => {
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-10 text-center">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-4">
            {t("Hemorrhoid surgery")}
          </h1>
          <p className="text-gray-600">
            {t(
              "Understand what hemorrhoids are, what causes them, and when surgery becomes necessary to restore comfort and health."
            )}
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <img
            src={hemorrhoidImg}
            alt={t("Hemorrhoid surgery")}
            className="rounded-xl shadow-md w-full h-auto"
          />
          <div className="text-gray-700 space-y-4">
            <h2 className="text-2xl font-semibold text-blue-800">
              {t("What are Hemorrhoids?")}
            </h2>
            <p>{t("HemorrhoidsIntroP1")}</p>
            <p>{t("HemorrhoidsIntroP2")}</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12 space-y-4">
          ...
          <p className="text-gray-700">{t("HemorrhoidBenefits")}</p>
        </div>
...
export default HemorrhoidSurgery;
